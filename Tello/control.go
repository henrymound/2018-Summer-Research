              ...
              for(true){
                ...
                if(text == "m"){
                  ...
                  for(true){
                    ...
                    if(text == "u"){
                      fmt.Print("How fast up should I go, master? (0-100)\n")
                      var i int
                      fmt.Scan(&i)
                      drone.Up(i)
                      i = 0
                    ...
                    if(text == "d"){
                      fmt.Print("How fast down should I go, master? (0-100)\n")
                      var i int
                      fmt.Scan(&i)
                      drone.Down(i)
                      i = 0
                    ...
                    if(text == "f"){
                      fmt.Print("How fast forward should I go, master? (0-100)\n")
                      var i int
                      fmt.Scan(&i)
                      drone.Forward(i)
                      i = 0
                    ...
                    if(text == "b"){
                      fmt.Print("How fast backward should I go, master? (0-100)\n")
                      var i int
                      fmt.Scan(&i)
                      drone.Backward(i)
                      i = 0
